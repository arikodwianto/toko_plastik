                ...
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-body p-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <!-- Informasi User -->
                            <div class="col-md-5">
                                <h3 class="fw-bold mb-2">Dashboard Kasir</h3>
                                <p class="fs-5 text-muted mb-0">
                                    Selamat datang kembali, <strong>{{ auth()->user()->name }}</strong>!  
                                    Anda login sebagai <span class="text-success fw-semibold">Kasir</span>.
                                </p>
                                <p class="mt-2 text-primary fw-semibold" id="tanggal-jam"></p>

                                <!-- Tombol -->
                                <div class="d-flex gap-2 mt-3 flex-wrap">
                                    <a href="{{ route('kasir.dashboard') }}" class="btn btn-primary px-4">
